...
| [`docs/SCHEMA.md`](./docs/SCHEMA.md) | Concrete **Supabase (Postgres)** schema — runnable DDL: tables, enums, foreign keys, indexes, RLS policies, storage buckets, and the sensitive-data vault. The physical realization of the ERD. |
